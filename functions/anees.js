...
// (اختياري) لو فيه preferred_formula وجهي صياغة السؤال بحيث يمكن حله بهذه الصيغة:
  if (preferred_formula) {
    prompt += `
- صِغ السؤال بحيث يكون قابلاً للحل مباشرة باستخدام الصيغة المختارة التالية (دون ذكر الصيغة صراحة للمستخدم):
${preferred_formula}
`;
  }
...
${preferred_formula}
- لا تستخدم صيغًا أخرى إلا عند الضرورة الواضحة، وحافظ على اتساق الخطوات مع هذه الصيغة.`;
  } else {
    prompt += `
